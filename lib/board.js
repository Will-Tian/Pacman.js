(function() {
  ...
  Board.prototype.notWall = function(value) {
    if(value === 0) {
      return true;
    } else if(value === "P") {
      return true;
  ...
  Board.prototype.draw = function() {
    for(var y=0;y<this.grid.length;y++) {
      for(var x=0;x<this.grid[0].length;x++){
        ...
        //add intersections to App.Boards.Intersections array
        if(this.notWall(this.grid[y][x])) {
          ...
          // this.gtx.fillRect(posX, posY, BLOCK_DIM[0], BLOCK_DIM[1]);
          if(this.notWall(this.grid[y][x + 1])) {
          ...
          if(this.notWall(this.grid[y + 1][x])) {
          ...
          if((this.grid[y + 1][x] === 0 || this.grid[y-1][x] === 0) && (this.grid[y][x + 1] === 0 || this.grid[y][x -1] === 0)) {
