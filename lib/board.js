    ...
    for(var y=0;y<this.grid.length;y++) {
      for(var x=0;x<this.grid[0].length;x++){
        ...
        if(this.grid[y][x] === "B") {
          var posX = $('#level-layer').position().left + 1 + x * BLOCK_DIM[0] + BLOCK_DIM[0];
          var posY = $('#level-layer').position().top + 1 + y * BLOCK_DIM[1] + BLOCK_DIM[1]/2;
          var blinky = new App.MovingObjects.Blinky([posX, posY], [0, 0], this.sprites, {blinkytx: this.blinkytx, board: this});
        ...
        if(this.grid[y][x] === "E") {
          var posX = $('#level-layer').position().left + 1 + x * BLOCK_DIM[0] + BLOCK_DIM[0];
          var posY = $('#level-layer').position().top + 1 + y * BLOCK_DIM[1] + BLOCK_DIM[1]/2;
          var pinky = new App.MovingObjects.Pinky([posX, posY], [0, 0], this.sprites, {pinkytx: this.pinkytx, board: this});
        ...
        if(this.grid[y][x] === "I") {
          var posX = $('#level-layer').position().left + 1 + x * BLOCK_DIM[0] + BLOCK_DIM[0];
          var posY = $('#level-layer').position().top + 1 + y * BLOCK_DIM[1] + BLOCK_DIM[1]/2;
          var inky = new App.MovingObjects.Inky([posX, posY], [0, 0], this.sprites, {inkytx: this.inkytx, board: this.board});
        ...
        if(this.grid[y][x] === "N") {
          ...
          var posY = $('#level-layer').position().top + 1 + y * BLOCK_DIM[1] + BLOCK_DIM[1]/2;
          var clyde = new App.MovingObjects.Clyde([posX, posY], [0, 0], this.sprites, {clydetx: this.clydetx, board: this.board});
