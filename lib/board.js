(function() {
  ...
  var Board = Boards.Board = function(grid, ctx, gtx, ptx, blinkytx, pinkytx, inkytx, clydetx, dotstx, sprites){
    this.grid = grid;
    this.ctx = ctx;
    this.gtx = gtx;
    this.ptx = ptx;
    ...
    for(var y=0;y<this.grid.length;y++) {
      for(var x=0;x<this.grid[0].length;x++){
        ...
        if(this.grid[y][x] === "P") {
          var posX = $('#level-layer').position().left + 1 + x * BLOCK_DIM[0] + BLOCK_DIM[0];
          var posY = $('#level-layer').position().top + 1 + y * BLOCK_DIM[1] + BLOCK_DIM[1]/2;
          var pacman = new App.MovingObjects.Pacman([posX, posY], [0, 0], this.sprites, this.ptx, this.gtx, this.dotstx);
        ...
        if(this.grid[y][x] === "B") {
          var posX = $('#level-layer').position().left + 1 + x * BLOCK_DIM[0] + BLOCK_DIM[0];
          var posY = $('#level-layer').position().top + 1 + y * BLOCK_DIM[1] + BLOCK_DIM[1]/2;
          var blinky = new App.MovingObjects.Blinky({pos: [posX, posY], vel: [0, 0], sprites: this.sprites, ptx: this.ptx, gtx: this.gtx, blinkytx: this.blinkytx});
        ...
        if(this.grid[y][x] === "E") {
          var posX = $('#level-layer').position().left + 1 + x * BLOCK_DIM[0] + BLOCK_DIM[0];
          var posY = $('#level-layer').position().top + 1 + y * BLOCK_DIM[1] + BLOCK_DIM[1]/2;
          var pinky = new App.MovingObjects.Pinky({pos: [posX, posY], vel: [0, 0], sprites: this.sprites, ptx: this.ptx, gtx: this.gtx, pdtx: this.pdtx, pinkytx: this.pinkytx});
        ...
        if(this.grid[y][x] === "I") {
          var posX = $('#level-layer').position().left + 1 + x * BLOCK_DIM[0] + BLOCK_DIM[0];
          var posY = $('#level-layer').position().top + 1 + y * BLOCK_DIM[1] + BLOCK_DIM[1]/2;
          var inky = new App.MovingObjects.Inky({pos: [posX, posY], vel: [0, 0], sprites: this.sprites, ptx: this.ptx, gtx: this.gtx, pdtx: this.pdtx, inkytx: this.inkytx});
        ...
        if(this.grid[y][x] === "N") {
          ...
          var posY = $('#level-layer').position().top + 1 + y * BLOCK_DIM[1] + BLOCK_DIM[1]/2;
          var clyde = new App.MovingObjects.Clyde({pos: [posX, posY], vel: [0, 0], sprites: this.sprites, ptx: this.ptx, gtx: this.gtx, pdtx: this.pdtx, clydetx: this.clydetx});
