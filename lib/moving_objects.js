(function() {
  ...
  var MovingObjects = App.MovingObjects.MovingObjects = function MovingObjects(pos, vel, sprites, ptx, gtx, blinkytx, pinkytx, inkytx, clydetx, dotstx) {
  	blinkytx
  	this.pos = pos;
  	this.vel = vel;
  	this.ptx = ptx;
  ...
  var Pacman = App.MovingObjects.Pacman = function Pacman(pos, vel, sprites, ptx, gtx, dotstx){
  	MovingObjects.call(this, pos, vel, sprites, ptx, gtx)
  	this.dotstx = dotstx;
  	this.moveQueue = [];
