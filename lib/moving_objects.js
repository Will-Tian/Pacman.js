(function() {
  ...
  var MovingObjects = App.MovingObjects.MovingObjects = function MovingObjects(pos, vel, sprites, homePos) {
  	this.pos = pos;
  	this.vel = vel;
  ...
  var Pacman = App.MovingObjects.Pacman = function Pacman(pos, vel, sprites, homePos, ptx, gtx, dotstx){
