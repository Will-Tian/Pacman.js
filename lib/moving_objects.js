(function() {
  ...
  var MovingObjects = App.MovingObjects.MovingObjects = function MovingObjects(pos, vel, sprites, ptx, gtx, blinkytx, pinkytx, inkytx, clydetx) {
  	blinkytx
  	this.pos = pos;
  	this.vel = vel;
  	this.ptx = ptx;
  ...
  var Pacman = App.MovingObjects.Pacman = function Pacman(options){
  	MovingObjects.call(this, options.pos, options.vel, options.sprites, options.ptx, options.gtx, options.blinkytx);
  	this.moveQueue = [];
 ...
 Pacman.prototype.eatDot = function() {
 	if(App.StationaryObjects.Objects[this.pos]){
