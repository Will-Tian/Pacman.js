(function() {
  ...
  var Ghost = App.MovingObjects.Ghost = function Ghost(pos, vel, sprites, homePos, options) {
  	MovingObjects.call(this, pos, vel, sprites, homePos) 
  ...
  var Blinky = App.MovingObjects.Blinky = function Blinky(pos, vel, sprites, homePos, options){
  	Ghost.call(this, pos, vel, sprites, homePos, options);
  ...
  var Pinky = App.MovingObjects.Pinky = function Pinky(pos, vel, sprites, homePos, options){
  	Ghost.call(this, pos, vel, sprites, homePos, options);
  	this.animationCycle = 0;
...
var Inky = App.MovingObjects.Inky = function Inky(pos, vel, sprites, homePos, options){
  	Ghost.call(this, pos, vel, sprites, homePos, options);
  	this.animationCycle = 0;
...
var Clyde = App.MovingObjects.Clyde = function Clyde(pos, vel, sprites, homePos, options){
  	Ghost.call(this, pos, vel, sprites, homePos, options);
  	this.animationCycle = 0;
